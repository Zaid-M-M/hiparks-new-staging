...
export const metadata = {
  guidebook_date: "2025-01-01",
  title:
    "Sustainable Warehousing Paving the Way for a Greener Logistics Landscape | Horizon Industrial Parks",
  description:
    ...
    <div className="w-full">
      <Header
        breadcrumbs={[
          ...
          { Guidebooks: "#" },
          {
            "Sustainable Warehousing Paving the Way for a Greener Logistics Landscape":
              "#",
          },
        ]}
        h1Line1="Sustainable Warehousing"
        h1Line2="Paving the Way for a Greener Logistics Landscape"
        abstractPosition="line1-right"
        headerImg="/white_paper/sw/header.webp"
      />
