              ...
              <div>
                <div className="flex gap-[17px] xl:gap-[20px]  xl:mb-[15px] md:mb-[10px]  mb-[25px] items-center">
                  <img
                    ...
                    src="/fmgc/build_fmcg_icon.svg"
                  />
                  <h3 className="text-[24px] md:text-[25px] lg:text-[24px] leading-[34px] md:leading-[36px] lg:leading-[35px] bw-m mb-[0px]">
                    Built for Fast- <br></br> Moving Goods
                  </h3>
                </div>

                <p className=" text-[18px] md:text-[17px] lg:text-[21px]  leading-[28px] bw-r">
                  Wide column spans, high clear heights, and dock-dense layouts
                  designed to handle quick inventory movement and frequent
                  dispatches.
                </p>
              </div>
            ...
            <div className="md:flex-1 xl:flex-none text-white bg-[#0db14b] relative pt-[30px] pb-[20px] lg:pt-[38px] xl:pt-[30px] 1366:pt-[38px] lg:pb-[48px] px-[20px] lg:px-[24px] flex md:h-[auto] lg:h-[296px] h-[auto]">
              <div>
                <div className="flex gap-[17px] xl:gap-[20px]  xl:mb-[15px] md:mb-[10px] mb-[25px] items-center">
                  <img
                    className="w-[60px] xl:w-[70px] 1440:w-[70px]"
                    src="/fmgc/strategic_fmcg_icon.svg"
                  />
                  <h3 className="text-[24px] md:text-[25px] lg:text-[24px] leading-[34px] md:leading-[36px] lg:leading-[35px] bw-m mb-[0px]">
                    Strategic Distribution <br></br>Access
                  </h3>
                </div>

                <p className=" text-[18px] md:text-[17px] lg:text-[21px]  leading-[28px] bw-r">
                  Located near major consumption centres and logistics
                  corridors—shorter lead times, lower costs, wider reach.
                </p>
              </div>
              <img
          ...
          <div className="flex flex-col md:flex-row xl:flex-col gap-[20px] flex-1 w-full xl:w-[465px] h-[100%]">
            ...
            <div className="md:flex-1 xl:flex-none text-white bg-[#8F53A1] relative pt-[30px] pb-[20px] lg:pt-[38px]  xl:pt-[30px] 1366:pt-[38px] lg:pb-[48px] px-[20px] lg:px-[24px] flex md:h-[auto] lg:h-[296px] h-[auto]">
              <div>
                <div className="flex gap-[17px] xl:gap-[20px]  xl:mb-[15px] md:mb-[10px]  mb-[25px] items-center">
                  <img
                    className="w-[60px] xl:w-[70px] 1440:w-[70px]"
                    src="/fmgc/festive_fmcg_icon.svg"
                  />
                  <h3 className="text-[24px] md:text-[25px] lg:text-[24px] leading-[34px] md:leading-[36px] lg:leading-[35px] bw-m mb-[0px]">
                    Festive-Ready <br></br>Flexibility
                  </h3>
                </div>

                <p className=" text-[18px] md:text-[17px] lg:text-[21px]  leading-[28px] bw-r">
                  Temporary storage options and scalable built-to-suit units
                  help you meet seasonal spikes without committing to long-term
                  capacity.
                </p>
              </div>
              <img
            ...
            <div className="md:flex-1 xl:flex-none text-white bg-[#000] relative pt-[30px] pb-[20px] lg:pt-[38px] xl:pt-[30px] 1366:pt-[38px] lg:pb-[48px] px-[20px] lg:px-[24px] flex md:h-[auto] lg:h-[296px] h-[auto]">
              <div>
                ...
                <p className=" text-[18px] md:text-[17px] lg:text-[21px]  leading-[28px] bw-r">
                  Rainwater harvesting, smart energy systems, solar rooftops,
                  and people-first amenities for a greener, better workspace.
                </p>
              </div>
              <img
