...
// export default Enablingcard;

import React from "react";

const Enablingcard = ({ amenities = [] }) => {
  return (
        ...
        {amenities.map((item, index) => (
          ...
          >
            <img
              ...
              alt={item.title}
            />
            <h3 className="text-white xl:w-[245px] 360:w-[135px] xl:text-[17px] md:text-[15px] text-[17px] 1440:text-[18px] bw-m 1440:leading-[25px] w-[235px] md:w-[200px] 360:text-[14px] 360:leading-[19px]">
              {item.title}
            </h3>
          </div>
        ))}
