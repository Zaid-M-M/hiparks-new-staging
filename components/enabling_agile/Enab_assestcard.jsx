...
// export default Enablingassestcard
//;

import React from "react";

const Enablingassestcard = ({ amenitiesasset = [] }) => {
  return (
    <div className="fix flex justify-center">
      <div className="grid grid-cols-2 w-[100%]  md:grid-cols-3 lg:grid-cols-4 gap-[14px] lg:gap-[14px] justify-center lg:justify-start">
        {amenitiesasset.map((item, index) => (
          <div
            key={index}
            className={`flex-shrink-0 h-[140px] border border-[#d4d4d4] w-full md:h-[180px] xl:w-[275px] 2xl:w-[324px] xl:h-[200px] flex flex-col   justify-center xl:justify-start gap-0 items-center text-center bg-white xl:py-[30px] xl:px-[20px] ${index === 4
                ? "lg:col-start-2 lg:row-start-2"
                : index === 5
                  ? "lg:col-start-3 lg:row-start-2"
                  : ""
          ...
          >
            <img
              src={item.image}
              className="md:w-[60px] md:h-[60px] aspect-square h-[30px] xl:w-[70px] xl:h-[70px] md:mb-[10px] 360:w-[60px] 360:h-[60px]"
              alt={item.title}
            />
            <h3 className="text-black xl:w-[245px] xl:text-[17px] md:text-[15px] text-[17px] 1440:text-[18px] bw-m 1440:leading-[25px] w-[235px] md:w-[200px] 360:text-[14px] 360:leading-[19px] 360:w-[135px]">
              {item.title}
            </h3>
          </div>
        ))}
