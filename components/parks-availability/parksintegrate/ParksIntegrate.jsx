...
const iboxs = [
  {
    ...
    text: "Based on strategic access points, infrastructure, scalability and local government support. ",
    heading: "Strategic Land Acquisition",
  },
  {
    icon: "/fulfillment_center/advance_sec3.svg",
    text: "Timely due diligence to accelerate operations at the parks",
    heading: "Park Compliances and Approvals",
  },
  {
    icon: "/fulfillment_center/fast_sec3.svg",
    text: "Ready-to-move, built-to-suit, multi-level facilities to meet complex industry requirements. ",
    heading: "Project Development",
  },
  {
    icon: "/fulfillment_center/fast_sec3.svg",
    text: "Multi-disciplinary facility management services for seamless operations.",
    heading: "Operations & Asset management",
  },
  //   {
...
const Parksintegrate = () => {
  return (
    ...
    <Btn text="WORKFORCE AMENITIES" className="hidden md:flex" />
        ...
        {/* ibox items */}
        <div className="flex flex-wrap w-full mt-0 gap-[13px] md:mt-[20px] md:gap-[10px] justify-between lg:flex-nowrap">
          {iboxs.map((ib, index) => (
            <div
              key={index}
