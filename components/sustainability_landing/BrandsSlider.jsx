...
import SlideCard from "../ecommerce/Ecom_sec5/SlideCard";
import { AnimatePresence, motion } from "framer-motion";
import clsx from "clsx";
import CustomDropdown from "../ecommerce/Ecom_sec5/CustomDropdown";
...
const logosPerTab = [21, 9, 18, 25, 9, 7, 17];
...
const ACTIVE_TAB_GRADIENT =
  "linear-gradient(125.13deg, #2BB04C 1.66%, #8F53A1 64.8%), linear-gradient(144.09deg, #8F53A1 24.25%, #F47920 88.66%), linear-gradient(148.33deg, #AC38D9 24.37%, #F47920 80.46%)";
...
const BrandsSlider = () => {
  ...
  return (
    <div
      className="w-full relative pt-[45px] lg:pt-[100px]"
    ...
    >
      ...
      />
      <img
        className="purple_vctr absolute w-[200px] md:w-[200px] lg:w-[300px] xl:w-[400px] top-[-50px]  md:left-[auto] md:right-[0px] left-[0px] md:top-[-80px] lg:top-[-120px] xl:left-[100px] 1920:left-[100px]"
          ...
          {categories.map((cat, i) => {
            ...
            return (
              <motion.button
                ...
                className={clsx(
                  "relative flex items-center justify-between md:px-[12px] 1366:px-[23px] 1366:py-[20px] border-r border-[#CDCDCD] overflow-hidden cursor-pointer focus:outline-none",
                )}
              >
                <div className="flex items-center justify-start w-full gap-2">
                  <motion.h2
                    ...
                    className={clsx(
                      "md:text-[16px] w-full text-left xl:text-[20px] 1366:text-[21px] bw-r leading-[150%]",
                    )}
                  >
                    {cat}
                  </motion.h2>
      ...
      <div className="mt-8 xl:!block !hidden lg:mt-[70px] relative">
        {filtered.length < 5 ? (
          ...
          <>
            ...
            <div className="swiper-button-prev-custom absolute top-[25%] left-0 min-h-[50%] lg:w-[150px] flex items-center justify-start z-10 cursor-pointer">
              <img
            ...
            <div className="swiper-button-next-custom absolute top-[25%] right-0 min-h-[50%] lg:w-[150px] flex items-center justify-end z-10 cursor-pointer">
              <img
