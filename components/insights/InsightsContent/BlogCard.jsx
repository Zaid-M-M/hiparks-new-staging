...
const BlogCard = ({ blog }) => {
  ...
  const imageUrl = blog.acf?.blog_image || blog.acf?.client_stories_image;
  ...
  const blogUrl = blog.acf?.client_stories_image
    ? `/case-studies-and-client-testimonials/${blog.slug}`
    : `/blog/${blog.slug}`;
  ...
  console.log("BlogCard category:", category); // Debugging log
