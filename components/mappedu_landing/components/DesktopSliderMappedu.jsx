...
import "swiper/css/effect-fade";
import "swiper/css/effect-fade";
import { DetailRow } from "../../parks-availability/components/SharedComponents";
    ...
    >
      {slides.map((slide, i) => (
        <SwiperSlide key={i} className="bg-white">
          <div className="flex flex-col h-full bg-white">
            <div className="flex flex-col lg:flex-row flex-1 min-h-0">
              <div className="lg:w-[28%] flex flex-col border-r-1  border-[#CDCDCD] ">
                <div className="flex justify-between gap-4 2xl:mb-6 lg:mb-2 border-b-1 border-[#CDCDCD] p-5">
                  <h3 className="text-[26px]  font-medium">{slide.title}</h3>
                  {slides.length > 1 && (
                    <div className="flex items-center gap-4">
                      <button
              ...
              <div className="lg:w-[80%] relative p-4 md:p-0 flex items-center justify-center overflow-hidden h-[300px] lg:h-auto border-t lg:border-t-0  border-gray-100 ">
                <img
            ...
            {/* <div className="w-full border-t-2 border-[#CDCDCD] bg-white p-6 md:px-10 pt-[38px] pb-[40px] grid grid-cols-2 md:grid-cols-4 gap-9 text-xs font-medium text-[#000000]"> */}
            <div className="flex flex-col gap-3 w-full border-t-1 border-[#CDCDCD] bg-white px-6 md:px-7 md:py-5 py-3">
