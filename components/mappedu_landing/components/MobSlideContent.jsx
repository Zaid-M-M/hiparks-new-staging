...
//                 <div className="w-full border-t-2 border-[#CDCDCD]"></div>
...
const MobSlideContent = ({ region, park, onImageClick }) => {
  ...
  return (
    <div className="bg-white text-black overflow-hidden h-full border-1 border-[#CDCDCD]">
          ...
          {park.slides.map((slide, slideIndex) => (
            ...
            <SwiperSlide className="!h-full" key={slideIndex}>
              <div className="flex flex-col w-full h-full">
                ...
                <div className="w-full border-t-1 border-[#CDCDCD]"></div>
                ...
                <div className="w-full border-t-1 mb-0 border-[#CDCDCD]"></div>
                ...
                <div className="py-4 bg-white px-4 mt-auto">
                  <h4 className="text-[16px] uppercase font-medium mb-3">
                    Ease of Connectivity:
                  </h4>
