...
const WarehousingForm = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url("/chengal_landing/first_sec.webp")`,
      }}
    >
      ...
      <div className="fix pb-20">
        <div className="flex flex-col pt-12 lg:flex-row items-end justify-end gap-12 lg:gap-8">
          ...
          <div className="lg:w-[50%] flex flex-col justify-center gap-5 lg:gap-10 w-full lg:pb-6">
            ...
            <button className="flex justify-between lg:h-[56px] tracking-[2px] items-center gap-3 bg-none border-2 p-2 mr-auto border-white lg:px-[20px] lg:py-[14px] text-white text-xl font-medium max-w-fit">
              <img
