                ...
                <div className="flex flex-wrap gap-[10px]">
                  {filteredHipData.map((hip_pdf, index) => (
                    <a
                      ...
                      target="_blank"
                      className="flex justify-between items-center gap-[5px] w-[100%] md:w-[48%] xl:w-[49%] h-[70px] 1280:h-[100px] bg-[#f7c99b] bw-r text-[17px] md:text-[14px] md:leading-[17px] xl:text-[22px] xl:leading-[26px] leading-[23px] tracking-[-1.04px] md:py-[20px] md:px-[15px] py-[22px] px-[20px] 1280:pl-[30px] 1280:pr-[25px] relative overflow-hidden"
                    >
                      {hip_pdf.title}
                      <img
