...
const AUTOMOTIVE_MICROBLOG_API =
  "https://phpstack-725513-2688800.cloudwaysapps.com/cms/wp-json/wp/v2/automomotive_micro";

const RelatedSectorLinks = ({
  basePath = "/automotive-&-auto-components",
  apiUrl = AUTOMOTIVE_MICROBLOG_API,
}) => {
...
export default RelatedSectorLinks;
