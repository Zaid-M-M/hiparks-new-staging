...
//   const [threshold, setThreshold] = useState(3); // default desktop

//   // 🖥️ Responsive threshold for grid vs swiper
//   useEffect(() => {
...
//   // ✨ Single Skeleton Card (breathing effect)
...
//   // Map slug to InCity key (e.g., 'delhi' -> 'NCR', 'tamil-nadu' -> 'tamilnadu')
...
//   // Fetch both Industrial & InCity Centers
//   useEffect(() => {
//     if (!slug) return;
...
//       // === Fetch InCity Centers (/incity_parks) ===
