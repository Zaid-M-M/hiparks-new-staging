...
const Slider = () => {
  ...
  return (
    <div className="w-full relative pt-[45px] lg:pt-[100px] overflow-hidden">
              ...
              >
                <div className="flex items-center justify-start w-full gap-2">
                  <motion.h2
                    ...
                    className={clsx(
                      "md:text-[16px]  text-left xl:text-[20px] 1366:text-[23px] bw-r leading-[32px]",
                    )}
                  >
                    {cat}
                  </motion.h2>
      ...
      {/* Slider */}
      <div className="mt-8 xl:!block !hidden lg:mt-[70px] lg:mb-[50px] relative">
        {filtered.length < 5 ? (
          // STATIC MODE
            ...
            >
              <div className="flex justify-center items-center flex-wrap">
                {filtered.map((img) => (
                  <div
                    key={img.id}
                    className="flex items-center justify-center border border-[#CDCDCD] aspect-square w-[304px] h-[160px]"
                  >
                    <img
                      src={img.src}
                      alt="brand"
          ...
          <>
            ...
            {/* Custom arrows (only for slider mode) - positioned at center bottom */}
            <div className="flex items-center justify-center gap-4 z-10 pb-4 mt-[50px]">
              <div className="swiper-button-prev-custom w-10 h-10 sm:w-12 sm:h-12 md:w-[50px] md:h-[50px] lg:w-[60px] lg:h-[60px]  xl:w-[70px] xl:h-[70px] flex items-center justify-center cursor-pointer border border-[#CDCDCD]">
                <img
              ...
              <div className="swiper-button-next-custom w-10 h-10 sm:w-12 sm:h-12 md:w-[50px] md:h-[50px] lg:w-[60px] lg:h-[60px]  xl:w-[70px] xl:h-[70px] flex items-center justify-center cursor-pointer border border-[#CDCDCD]">
                <img
