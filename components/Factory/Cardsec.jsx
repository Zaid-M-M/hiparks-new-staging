  ...
  return (
    <div className="bg-black lg:py-24 py-12 relative min-h-screen flex items-center">
      ...
      <div className="fix ">
        ...
        <div className="flex relative z-20 justify-between md:mt-[49px] mt-5 sm:mt-[40px] flex-col gap-[10px] sm:gap-[20px]">
          <div className="flex sm:gap-[20px] gap-[10px] md:flex-row flex-col">
            <div className=" text-white md:w-1/2 bg-[#F47922] relative lg:px-[18px] lg:py-[20px] 1440:px-[24px] 1440:py-[30px] px-[15px] py-[20px]  h-auto  md:h-[290px] xl:h-[255px] 1440:h-[270px] sm:h-[240px] flex items-center">
              <div className="flex h-full flex-col gap-[10px]">
                <h3 className="text-[25px]  leading-[35px] capitalize xl:text-[25px] xl:leading-[25px] 1440:text-[28px] 1440:leading-[28px] 1600:text-[30px] 1600:leading-[40px] bw-m mb-[0px] md:mb-[14px]">
                  Providing Speed To Market Plug And Play Spaces
                </h3>
                <p className="1536:w-[605px] text-[16px] lg:text-[19px]  1440:text-[20px] leading-[150%] bw-r">
            ...
            <div className=" text-white md:w-1/2 bg-[#8A52A0] relative lg:px-[18px] lg:py-[20px] 1440:px-[24px] 1440:py-[30px] px-[15px] py-[20px]  h-auto  md:h-[290px] xl:h-[255px] 1440:h-[270px] sm:h-[240px]  flex items-center">
              <div className="flex h-full flex-col gap-[10px]">
                <h3 className="text-[25px]  leading-[35px] capitalize xl:text-[25px] xl:leading-[25px] 1440:text-[28px] 1440:leading-[28px] 1600:text-[30px] 1600:leading-[40px] bw-m mb-[0px] md:mb-[14px]">
          ...
          <div className="flex gap-[10px] sm:gap-[20px] md:flex-row flex-col">
            <div className=" text-white md:w-1/2 bg-[#0db14b] relative lg:px-[18px] lg:py-[20px] 1440:px-[24px] 1440:py-[30px] px-[15px] py-[20px]  h-auto  md:h-[290px] xl:h-[255px] 1440:h-[270px] sm:h-[240px] flex items-center">
              <div className="flex h-full flex-col gap-[10px]">
                <h3 className="text-[25px]  leading-[35px] capitalize xl:text-[25px] xl:leading-[25px] 1440:text-[28px] 1440:leading-[28px] 1600:text-[30px] 1600:leading-[40px] bw-m mb-[0px] md:mb-[14px]">
            ...
            <div className=" text-white md:w-1/2 bg-[#313131] relative lg:px-[18px] lg:py-[20px] 1440:px-[24px] 1440:py-[30px] px-[15px] py-[20px]  h-auto  md:h-[290px] xl:h-[255px] 1440:h-[270px] sm:h-[240px]  flex items-center">
              <div className="flex h-full flex-col gap-[10px]">
                <h3 className="text-[25px]  leading-[35px] capitalize xl:text-[25px] xl:leading-[25px] 1440:text-[28px] 1440:leading-[28px] 1600:text-[30px] 1600:leading-[40px] bw-m mb-[0px] md:mb-[14px]">
                  Provision For Advanced Factory Requirements
                </h3>
                <p className="1536:w-[605px] text-[16px] lg:text-[19px]  1440:text-[20px] leading-[150%] bw-r">
                  Engineered for high-performance manufacturing, Horizon equips
                  your operations with features like clean rooms, floor
                  modifications, recessed docks, dust-free zones, cold rooms,
                  FM-grade fire system enhancements, and infrastructural
                  readiness for EOT cranes and machinery - enabling you to meet
                  strict production needs with ease.
                </p>
              </div>
              <img
