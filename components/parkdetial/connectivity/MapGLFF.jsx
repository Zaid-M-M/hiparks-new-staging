        ...
        >
          ...
          <div className="absolute bottom-0 left-0 flex flex-col gap-0 z-50">
            <button
              ...
              className="w-[70px] h-[70px] bg-white text-[20px] flex items-center justify-center text-black font-bold border-b border-black"
            >
              <PlusIcon className="w-[30px] h-[30px]" />
            </button>
            <button
              onClick={handleZoomOut}
              className="w-[70px] h-[70px] bg-white text-[20px] flex items-center justify-center text-black font-bold"
            >
