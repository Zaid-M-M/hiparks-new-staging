...
const amenities = [
  {
    icon: "/bts_campaign/icons/buildheight.svg",
    title: "Customised factory set-ups with zero upfront investments",
  },
  {
    icon: "/bts_campaign/icons/wide.svg",
    title: "Flexible spaces for phased expansion",
  },
  {
    icon: "/bts_campaign/icons/3b.svg",
    title: "Tailored rental plans",
  },
  {
    icon: "/bts_campaign/icons/udl.png",
    title: "Heavy-duty industrial flooring",
  },
  {
    icon: "/bts_campaign/icons/5b.svg",
    title: "Utility-ready infrastructure",
  },
  {
    icon: "/bts_campaign/icons/6b.svg",
    title: "EOT crane-ready facilities",
  },
  {
    icon: "/bts_campaign/icons/7b.svg",
    title: "Structured operational layouts",
  },
  {
    icon: "/bts_campaign/icons/8b.svg",
    title: "Process-oriented facility planning",
  },
  { icon: "/bts_campaign/icons/9b.svg", title: "Recessed docks" },
  {
    icon: "/bts_campaign/icons/10b.svg",
    title: "Clean room capability",
  },
  {
    icon: "/bts_campaign/icons/11b.svg",
    title: "Dust-free zones",
  },
  {
    icon: "/bts_campaign/icons/12b.svg",
    title: "Cold room integration",
  },
  {
    icon: "/bts_campaign/icons/13b.svg",
