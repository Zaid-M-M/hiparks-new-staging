...
const WarehousingForm = () => {
  ...
  const trackFormSubmission = () => {
    if (typeof window !== "undefined") {
      ...
      console.log("GTM event fired: bts_campaign_form_submit");
  ...
  const getTemplateId = (location) => {
    ...
    if (north.includes(location)) return "template_av4boic";
    if (south.includes(location)) return "template_av4boic";
    return "template_av4boic";
  };
  ...
  const sendEmail = async (e) => {
    ...
    try {
      ...
      await Promise.all([
        ...
        fetch(
          "https://script.google.com/macros/s/AKfycbyrvkiRLyZw480fv6KQr7vhEoT-4_REQZCeNLmVPGaeNoPUCzgHBHooXbbfhouDubWR6Q/exec",
          {
            method: "POST",
            mode: "no-cors",
          ...
          <div className="w-full lg:w-[40%] campaigninput bg-white flex flex-col gap-7 p-[20px] md:p-[30px] items-start">
            ...
            <form ref={formRef} onSubmit={sendEmail} className="w-full">
              ...
              <input
                ...
                value={inquirySource}
              />
              <input type="hidden" name="Form_Type__c" value="BTS Campaign" />
