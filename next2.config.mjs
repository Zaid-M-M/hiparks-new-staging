...
const CSP = [
  ...
  // ✅ Scripts — Google, Facebook, LinkedIn, Tidio, Vimeo, Clarity, EmailJS
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' " +
    ...
    "https://maps.googleapis.com https://maps.gstatic.com https://*.googleapis.com https://*.gstatic.com " +
    "https://phpstack-725513-2688800.cloudwaysapps.com https://phpstack-725513-2801524.cloudwaysapps.com https://phpstack-725513-4957654.cloudwaysapps.com",
  ...
  // ✅ Styles — Google Fonts + inline styles (needed by maps, tidio, vimeo)
  "style-src 'self' 'unsafe-inline' " +
    "https://fonts.googleapis.com https://*.googleapis.com " +
    "https://*.tidio.co " +
    "https://phpstack-725513-2688800.cloudwaysapps.com https://phpstack-725513-2801524.cloudwaysapps.com https://phpstack-725513-4957654.cloudwaysapps.com",

  // ✅ Fonts — Google Fonts + data URIs (used by some icon fonts)
  "font-src 'self' data: " +
    "https://fonts.gstatic.com https://*.gstatic.com " +
    "https://*.tidio.co " +
    "https://phpstack-725513-2688800.cloudwaysapps.com https://phpstack-725513-2801524.cloudwaysapps.com https://phpstack-725513-4957654.cloudwaysapps.com",

  // ✅ Images — Vimeo thumbnails, Google Maps, Facebook pixel, LinkedIn, Clarity
  ...
  // ✅ Media — Vimeo video streams
  "media-src 'self' blob: " +
    "https://player.vimeo.com https://*.vimeocdn.com https://*.vimeo.com " +
    "https://*.tidio.co " +
    "https://phpstack-725513-2688800.cloudwaysapps.com https://phpstack-725513-2801524.cloudwaysapps.com https://phpstack-725513-4957654.cloudwaysapps.com",

  // ✅ Frames — Vimeo player, Google Maps embed, virtual tour, Facebook
  "frame-src " +
  ...
  // ✅ Connections — API calls, analytics, websockets (Tidio live chat needs wss://)
  "connect-src 'self' " +
    "https://phpstack-725513-2688800.cloudwaysapps.com https://phpstack-725513-2801524.cloudwaysapps.com https://phpstack-725513-4957654.cloudwaysapps.com " +
    "https://script.google.com https://script.googleusercontent.com " +
    "https://api.emailjs.com " +
    "https://www.google-analytics.com https://*.google-analytics.com " +
    "https://region1.google-analytics.com https://region1.analytics.google.com https://*.analytics.google.com " +
  ...
  // ✅ Web workers — used by Google Maps, Tidio, analytics
  "worker-src 'self' blob:",

  // 🔒 Prevents this site from being embedded in iframes on other domains
